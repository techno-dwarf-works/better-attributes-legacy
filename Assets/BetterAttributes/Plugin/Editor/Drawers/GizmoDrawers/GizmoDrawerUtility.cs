...
using BetterAttributes.Plugin.Editor.Drawers.GizmoDrawers.LocalWrappers;
using BetterAttributes.Plugin.Editor.Drawers.GizmoDrawers.Wrappers;
using BetterAttributes.Plugin.EditorAddons.GizmoAttributes;
using UnityEditor;
using UnityEditor.Callbacks;

namespace BetterAttributes.Plugin.Editor.Drawers.GizmoDrawers
{
